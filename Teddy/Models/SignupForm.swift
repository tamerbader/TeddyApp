...
class SignupForm {
    ...
    public func generateField() -> Field {
        ...
        case .FAMILY_ID:
            return Field(title: "Have a family id? If not, just leave blank", placeholder: "Enter Family ID", contentType: .oneTimeCode, keyboardType: .asciiCapable, infoType: .FAMILY_ID)
        case .PASSWORD:
