...
extension TrackingService: LocationUpdateDelegate {
    func didReceiveNewLocation(_ location: CLLocation) {
        ...
        if (LocationServices.isWithinRange(source: location, destination: getTargetLocation(), range: RADIUS)) {
...
extension TrackingService: TimerUpdateDelegate {
